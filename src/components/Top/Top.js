...
import parts from "../images/100816-cc-upcycle-your-recycling-with-great-ideas-for-old-tire-parts-1.jpg";
import repair from "../images/Tire-Engine-Maintenance-cropped_iStock.png";
          ...
          <div className="container">
            ...
            <div className="row justify-content-center align-items-center projects">
              <Scroll type="id" element="_contact">
                ...
                >
                  ...
                  <p className="description" style={{ color: "black" }}>
                    We provide a large spectrum of tire service
                  </p>
                </div>
              </Scroll>
              ...
              <Link className="links" to="/parts">
                <div className="col-sm-6 col-lg-4 item">
                  <img className="img-fluid" src={parts} alt="hui3" />
